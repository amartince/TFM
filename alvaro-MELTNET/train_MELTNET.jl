...
model_yelmo = MELTNET(params_2, DAEnet_2, nClasses, state_2, true)
...
BSON.@save "MELTNET_100epoch_randomweight_lr0005.bson" model_state = estado_modelo
...
with_theme(theme_latexfonts()) do
    ...
    #CairoMakie.save("imagenes/MELTNET_100epoch_randomweight_lr0005.png", f)
    f
end